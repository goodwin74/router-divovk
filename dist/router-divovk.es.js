...
function p() {
  return u || (u = 1, "production" !== process.env.NODE_ENV && function() {
    ...
    function i2(e2, t3, o3, a3, i3, u3, y2, p3) {
      var d3, m3 = t3.children;
      if (void 0 !== m3) if (a3) if (N(m3)) {
        for (a3 = 0; a3 < m3.length; a3++) s2(m3[a3]);
      ...
      if ($.call(t3, "key")) {
        ...
        a3 = 0 < b3.length ? "{key: someKey, " + b3.join(": ..., ") + ": ...}" : "{key: someKey}", A[m3 + a3] || (b3 = 0 < b3.length ? "{" + b3.join(": ..., ") + ": ...}" : "{}", console.error('A props object containing a "key" prop is being spread into JSX:\n  let props = %s;\n  <%s {...props} />\nReact keys must be passed directly to JSX without using spread:\n  let props = %s;\n  <%s key={someKey} {...props} />', a3, m3, b3, m3), A[m3 + a3] = true);
      }
      ...
      }(o3, "function" == typeof e2 ? e2.displayName || e2.name || "Unknown" : e2), function(e3, r3, t4, n3, o4, a4, i4, s3) {
        return t4 = a4.ref, e3 = { $$typeof: f2, type: e3, key: r3, props: a4, _owner: o4 }, null !== (void 0 !== t4 ? t4 : null) ? Object.defineProperty(e3, "ref", { enumerable: false, get: l2 }) : Object.defineProperty(e3, "ref", { enumerable: false, value: null }), e3._store = {}, Object.defineProperty(e3._store, "validated", { configurable: false, enumerable: false, writable: true, value: 0 }), Object.defineProperty(e3, "_debugInfo", { configurable: false, enumerable: false, writable: true, value: null }), Object.defineProperty(e3, "_debugStack", { configurable: false, enumerable: false, writable: true, value: i4 }), Object.defineProperty(e3, "_debugTask", { configurable: false, enumerable: false, writable: true, value: s3 }), Object.freeze && (Object.freeze(e3.props), Object.freeze(e3)), e3;
    ...
    var c2, u2 = e, f2 = Symbol.for("react.transitional.element"), p2 = Symbol.for("react.portal"), d2 = Symbol.for("react.fragment"), m2 = Symbol.for("react.strict_mode"), b2 = Symbol.for("react.profiler"), h2 = Symbol.for("react.consumer"), v2 = Symbol.for("react.context"), g2 = Symbol.for("react.forward_ref"), k2 = Symbol.for("react.suspense"), S = Symbol.for("react.suspense_list"), j = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), _ = Symbol.for("react.activity"), x = Symbol.for("react.client.reference"), O = u2.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, $ = Object.prototype.hasOwnProperty, N = Array.isArray, E = console.createTask ? console.createTask : function() {
      ...
      return e2();
    } })["react-stack-bottom-frame"].bind(u2, a2)(), P = E(o2(a2)), A = {};
    y.Fragment = d2, y.jsx = function(e2, r3, t3, n3, a3) {
      var l3 = 1e4 > O.recentlyCreatedOwnerStacks++;
      return i2(e2, r3, t3, false, 0, a3, l3 ? Error("react-stack-top-frame") : R, l3 ? E(o2(e2)) : P);
    }, y.jsxs = function(e2, r3, t3, n3, a3) {
      var l3 = 1e4 > O.recentlyCreatedOwnerStacks++;
      return i2(e2, r3, t3, true, 0, a3, l3 ? Error("react-stack-top-frame") : R, l3 ? E(o2(e2)) : P);
    };
  }()), y;
}
var d = (f || (f = 1, "production" === process.env.NODE_ENV ? s.exports = function() {
  if (i) return c;
  i = 1;
...
}() : s.exports = p()), s.exports);
const m = "_activity_1syf0_1", b = "_activityCont_1syf0_21", h = r(), v = ({ children: e2 }) => {
  const [r2, l2] = t([]), i2 = n(r2), [s2, c2] = t({});
  let u2 = o((e3) => document.querySelector(e3), []), f2 = { open: (e3) => {
    u2(`#${e3}`).style.display = "block", setTimeout(() => {
      u2(`#${e3}`).style.zIndex = i2.current.length + 1, u2(`#${e3}`).style.transform = "translate(0%,0%)", u2(`#${e3}`).children[0].style.transform = "translate(0%,0%)";
    }, 100);
  }, close: (e3) => {
    u2(`#${e3}`).children[0].style.transform = "", setTimeout(() => {
      u2(`#${e3}`).style.transform = "", u2(`#${e3}`).style.zIndex = "-1", u2(`#${e3}`).style.display = "none";
    }, 400);
  }, init: (e3, r3) => {
    u2(`#${e3}`).style.display = "block", u2(`#${e3}`).style.zIndex = r3, u2(`#${e3}`).style.transform = "translate(0%,0%)", u2(`#${e3}`).children[0].style.transform = "translate(0%,0%)";
  } };
  const y2 = (e3) => {
    s2[e3] || c2((r3) => ({ ...r3, [e3]: true }));
  };
  a(() => {
    const e3 = (e4) => {
      e4 = e4 || false;
      const r4 = window.location.hash.slice(1).split("/").filter(Boolean);
      if (r4.length > i2.current.length) {
        let e5 = r4[r4.length - 1];
        f2.open(e5);
      } else if (r4.length < i2.current.length) {
        let e5 = i2.current[i2.current.length - 1];
        f2.close(e5);
      }
      true === e4 && i2.current.length > 0 && i2.current.forEach((e5, r5) => {
        y2(e5), f2.init(e5, r5 + 2);
      }), l2(r4), i2.current = r4;
    }, r3 = window.location.hash.slice(1);
    return i2.current = r3.split("/").filter(Boolean), e3(true), window.addEventListener("hashchange", e3), () => {
      window.removeEventListener("hashchange", e3);
    };
  }, []);
  const p2 = { blockHistory: r2, showBlock: (e3) => {
    y2(e3);
    ((e4) => {
      const r3 = e4.join("/");
      window.location.hash = r3 || "";
    })([...i2.current, e3]);
  }, getBlockStyle: (e3) => -1 !== r2.indexOf(e3), loadActivity: s2 };
  return d.jsx(h.Provider, { value: p2, children: e2 });
}, g = ({ id: e2, children: r2, activityStyle: n2, activityContStyle: o2, lazyLoad: i2 }) => {
  const { loadActivity: s2 } = l(h), [c2, u2] = t(false);
  return a(() => {
    s2[e2] && false === c2 && u2(true);
  }, [s2[e2]]), d.jsx(d.Fragment, { children: d.jsx("div", { id: e2, className: m, style: n2, children: d.jsx("div", { className: b, style: o2, children: i2 ? c2 && r2 : r2 }) }) });
}, k = ({ id: e2, toId: r2, children: t2, style: n2, className: o2 }) => {
